...
while True:
    ...
    if imagen_A6 is not None:
        ...
        for c_2 in contorno2:
            ...
            if area<9400 and area>11300:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "G/. 1000",(x,y) , font, 0.75, (0,255,0),2)
                suma1000=suma1000+1000

            if area<9300 and area>8000:
                font=cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "G/. 500",(x,y) , font, 0.75, (0,255,0),2)
                suma500=suma500+500
            
            
        total=suma1000+suma500+suma100
        print("Sumatoria total en Guaranies:",round(total,2))
